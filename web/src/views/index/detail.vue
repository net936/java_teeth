    ...
    <div class="detail-content">
      <div class="detail-content-top">
        ...
        <div class="top-right">
          ...
          <div class="meta">有效期：{{ detailData.youxiaoqi }}</div>
          <div class="meta">服务医生：{{ detailData.doctorTitle }}</div>
          <div class="meta">适用人群：{{ detailData.shiyong }}</div>
          <div class="meta">温馨提示：{{ detailData.tishi }}</div>
          <div class="actions">
